# Comparing `tmp/ht2-0.0.1.tar.gz` & `tmp/ht2-0.0.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "ht2-0.0.1.tar", last modified: Tue May 16 03:50:43 2023, max compression
+gzip compressed data, was "ht2-0.0.2.tar", last modified: Tue May 16 06:22:23 2023, max compression
```

## Comparing `ht2-0.0.1.tar` & `ht2-0.0.2.tar`

### file list

```diff
@@ -1,15 +1,17 @@
-drwxr-xr-x   0 agent_h    (501) staff       (20)        0 2023-05-16 03:50:43.122017 ht2-0.0.1/
--rw-r--r--   0 agent_h    (501) staff       (20)     1070 2023-05-16 03:28:49.000000 ht2-0.0.1/LICENSE
--rw-r--r--   0 agent_h    (501) staff       (20)      549 2023-05-16 03:50:43.121885 ht2-0.0.1/PKG-INFO
--rw-r--r--   0 agent_h    (501) staff       (20)       42 2023-05-16 03:28:49.000000 ht2-0.0.1/README.md
--rw-r--r--   0 agent_h    (501) staff       (20)      580 2023-05-16 03:33:20.000000 ht2-0.0.1/pyproject.toml
--rw-r--r--   0 agent_h    (501) staff       (20)       38 2023-05-16 03:50:43.122059 ht2-0.0.1/setup.cfg
-drwxr-xr-x   0 agent_h    (501) staff       (20)        0 2023-05-16 03:50:43.120112 ht2-0.0.1/src/
-drwxr-xr-x   0 agent_h    (501) staff       (20)        0 2023-05-16 03:50:43.120927 ht2-0.0.1/src/ht2/
--rw-r--r--   0 agent_h    (501) staff       (20)        0 2023-05-16 03:35:11.000000 ht2-0.0.1/src/ht2/__init__.py
--rw-r--r--   0 agent_h    (501) staff       (20)       71 2023-05-16 03:37:28.000000 ht2-0.0.1/src/ht2/example.py
-drwxr-xr-x   0 agent_h    (501) staff       (20)        0 2023-05-16 03:50:43.121696 ht2-0.0.1/src/ht2.egg-info/
--rw-r--r--   0 agent_h    (501) staff       (20)      549 2023-05-16 03:50:43.000000 ht2-0.0.1/src/ht2.egg-info/PKG-INFO
--rw-r--r--   0 agent_h    (501) staff       (20)      195 2023-05-16 03:50:43.000000 ht2-0.0.1/src/ht2.egg-info/SOURCES.txt
--rw-r--r--   0 agent_h    (501) staff       (20)        1 2023-05-16 03:50:43.000000 ht2-0.0.1/src/ht2.egg-info/dependency_links.txt
--rw-r--r--   0 agent_h    (501) staff       (20)        4 2023-05-16 03:50:43.000000 ht2-0.0.1/src/ht2.egg-info/top_level.txt
...
### Comparing `ht2-0.0.1/LICENSE` & `ht2-0.0.2/LICENSE`

 * *Files identical despite different names*

### Comparing `ht2-0.0.1/PKG-INFO` & `ht2-0.0.2/PKG-INFO`
...
### Comparing `ht2-0.0.1/pyproject.toml` & `ht2-0.0.2/pyproject.toml`
...
### Comparing `ht2-0.0.1/src/ht2.egg-info/PKG-INFO` & `ht2-0.0.2/src/ht2.egg-info/PKG-INFO`
