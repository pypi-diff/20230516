# Comparing `tmp/flytekitplugins-data-fsspec-1.6.0b4.tar.gz` & `tmp/flytekitplugins-data-fsspec-1.6.1b0.tar.gz`
...
## Comparing `flytekitplugins-data-fsspec-1.6.0b4.tar` & `flytekitplugins-data-fsspec-1.6.1b0.tar`
...
### Comparing `flytekitplugins-data-fsspec-1.6.0b4/PKG-INFO` & `flytekitplugins-data-fsspec-1.6.1b0/PKG-INFO`
...
### Comparing `flytekitplugins-data-fsspec-1.6.0b4/flytekitplugins_data_fsspec.egg-info/PKG-INFO` & `flytekitplugins-data-fsspec-1.6.1b0/flytekitplugins_data_fsspec.egg-info/PKG-INFO`
...
### Comparing `flytekitplugins-data-fsspec-1.6.0b4/setup.py` & `flytekitplugins-data-fsspec-1.6.1b0/setup.py`
