# Comparing `tmp/data_loader_xyz-0.0.2.tar.gz` & `tmp/data_loader_xyz-0.0.3.tar.gz`
...
## Comparing `data_loader_xyz-0.0.2.tar` & `data_loader_xyz-0.0.3.tar`
...
### Comparing `data_loader_xyz-0.0.2/LICENCE` & `data_loader_xyz-0.0.3/LICENCE`

 * *Files identical despite different names*

### Comparing `data_loader_xyz-0.0.2/PKG-INFO` & `data_loader_xyz-0.0.3/PKG-INFO`
...
### Comparing `data_loader_xyz-0.0.2/README.md` & `data_loader_xyz-0.0.3/README.md`

 * *Files identical despite different names*

### Comparing `data_loader_xyz-0.0.2/data_loader_xyz.egg-info/PKG-INFO` & `data_loader_xyz-0.0.3/data_loader_xyz.egg-info/PKG-INFO`
...
### Comparing `data_loader_xyz-0.0.2/setup.py` & `data_loader_xyz-0.0.3/setup.py`

 * *Files identical despite different names*

### Comparing `data_loader_xyz-0.0.2/utils/util.py` & `data_loader_xyz-0.0.3/utils/util.py`
