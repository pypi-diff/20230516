# Comparing `tmp/artistools-2023.5.16.tar.gz` & `tmp/artistools-2023.5.16.2.tar.gz`
...
### Comparing `artistools-2023.5.16/.codecov.yml` & `artistools-2023.5.16.2/.codecov.yml`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/.github/workflows/deploypypi.yml` & `artistools-2023.5.16.2/.github/workflows/deploypypi.yml`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/.github/workflows/deploytestpypi.yml` & `artistools-2023.5.16.2/.github/workflows/deploytestpypi.yml`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/.github/workflows/linter.yml` & `artistools-2023.5.16.2/.github/workflows/linter.yml`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/.github/workflows/pytest.yml` & `artistools-2023.5.16.2/.github/workflows/pytest.yml`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/.gitignore` & `artistools-2023.5.16.2/.gitignore`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/.pre-commit-config.yaml` & `artistools-2023.5.16.2/.pre-commit-config.yaml`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/CODEOWNERS` & `artistools-2023.5.16.2/CODEOWNERS`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/LICENSE.txt` & `artistools-2023.5.16.2/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/PKG-INFO` & `artistools-2023.5.16.2/PKG-INFO`
...
### Comparing `artistools-2023.5.16/README.md` & `artistools-2023.5.16.2/README.md`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/__init__.py` & `artistools-2023.5.16.2/artistools/__init__.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/__main__.py` & `artistools-2023.5.16.2/artistools/__main__.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/atomic/_atomic_core.py` & `artistools-2023.5.16.2/artistools/atomic/_atomic_core.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/codecomparison.py` & `artistools-2023.5.16.2/artistools/codecomparison.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/commands.py` & `artistools-2023.5.16.2/artistools/commands.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/configuration.py` & `artistools-2023.5.16.2/artistools/configuration.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/ElBiEn_2007.txt` & `artistools-2023.5.16.2/artistools/data/ElBiEn_2007.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/atomic_properties.txt` & `artistools-2023.5.16.2/artistools/data/atomic_properties.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/betaminusdecays.txt` & `artistools-2023.5.16.2/artistools/data/betaminusdecays.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/binding_energies.txt` & `artistools-2023.5.16.2/artistools/data/binding_energies.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/collion-AR1985.txt` & `artistools-2023.5.16.2/artistools/data/collion-AR1985.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/collion-reference.txt` & `artistools-2023.5.16.2/artistools/data/collion-reference.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/collion.txt` & `artistools-2023.5.16.2/artistools/data/collion.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/elements.csv` & `artistools-2023.5.16.2/artistools/data/elements.csv`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/400.txt` & `artistools-2023.5.16.2/artistools/data/filters/400.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/520.txt` & `artistools-2023.5.16.2/artistools/data/filters/520.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/ASIAGO/B.txt` & `artistools-2023.5.16.2/artistools/data/filters/ASIAGO/B.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/ASIAGO/U.txt` & `artistools-2023.5.16.2/artistools/data/filters/ASIAGO/U.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/ASIAGO/V.txt` & `artistools-2023.5.16.2/artistools/data/filters/ASIAGO/V.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/ASIAGO/gs.txt` & `artistools-2023.5.16.2/artistools/data/filters/ASIAGO/gs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/ASIAGO/is.txt` & `artistools-2023.5.16.2/artistools/data/filters/ASIAGO/is.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/ASIAGO/rs.txt` & `artistools-2023.5.16.2/artistools/data/filters/ASIAGO/rs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/ASIAGO/zs.txt` & `artistools-2023.5.16.2/artistools/data/filters/ASIAGO/zs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/B.txt` & `artistools-2023.5.16.2/artistools/data/filters/B.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/FUV.txt` & `artistools-2023.5.16.2/artistools/data/filters/FUV.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/H.txt` & `artistools-2023.5.16.2/artistools/data/filters/H.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/H_ab.txt` & `artistools-2023.5.16.2/artistools/data/filters/H_ab.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/I.txt` & `artistools-2023.5.16.2/artistools/data/filters/I.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/J.txt` & `artistools-2023.5.16.2/artistools/data/filters/J.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/J_ab.txt` & `artistools-2023.5.16.2/artistools/data/filters/J_ab.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/K.txt` & `artistools-2023.5.16.2/artistools/data/filters/K.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/K_ab.txt` & `artistools-2023.5.16.2/artistools/data/filters/K_ab.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/LCOGT/B.txt` & `artistools-2023.5.16.2/artistools/data/filters/LCOGT/B.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/LCOGT/I.txt` & `artistools-2023.5.16.2/artistools/data/filters/LCOGT/I.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/LCOGT/R.txt` & `artistools-2023.5.16.2/artistools/data/filters/LCOGT/R.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/LCOGT/U.txt` & `artistools-2023.5.16.2/artistools/data/filters/LCOGT/U.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/LCOGT/V.txt` & `artistools-2023.5.16.2/artistools/data/filters/LCOGT/V.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/LCOGT/gs.txt` & `artistools-2023.5.16.2/artistools/data/filters/LCOGT/gs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/LCOGT/is.txt` & `artistools-2023.5.16.2/artistools/data/filters/LCOGT/is.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/LCOGT/rs.txt` & `artistools-2023.5.16.2/artistools/data/filters/LCOGT/rs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/LCOGT/us.txt` & `artistools-2023.5.16.2/artistools/data/filters/LCOGT/us.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/LCOGT/zs.txt` & `artistools-2023.5.16.2/artistools/data/filters/LCOGT/zs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/LSQ/rs.txt` & `artistools-2023.5.16.2/artistools/data/filters/LSQ/rs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/LT/gs.txt` & `artistools-2023.5.16.2/artistools/data/filters/LT/gs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/LT/is.txt` & `artistools-2023.5.16.2/artistools/data/filters/LT/is.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/LT/rs.txt` & `artistools-2023.5.16.2/artistools/data/filters/LT/rs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/LT/us.txt` & `artistools-2023.5.16.2/artistools/data/filters/LT/us.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/LT/zs.txt` & `artistools-2023.5.16.2/artistools/data/filters/LT/zs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/NOT/B.txt` & `artistools-2023.5.16.2/artistools/data/filters/NOT/B.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/NOT/I.txt` & `artistools-2023.5.16.2/artistools/data/filters/NOT/I.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/NOT/R.txt` & `artistools-2023.5.16.2/artistools/data/filters/NOT/R.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/NOT/U.txt` & `artistools-2023.5.16.2/artistools/data/filters/NOT/U.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/NOT/V.txt` & `artistools-2023.5.16.2/artistools/data/filters/NOT/V.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/NOT/gs.txt` & `artistools-2023.5.16.2/artistools/data/filters/NOT/gs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/NOT/is.txt` & `artistools-2023.5.16.2/artistools/data/filters/NOT/is.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/NOT/rs.txt` & `artistools-2023.5.16.2/artistools/data/filters/NOT/rs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/NOT/us.txt` & `artistools-2023.5.16.2/artistools/data/filters/NOT/us.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/NOT/zs.txt` & `artistools-2023.5.16.2/artistools/data/filters/NOT/zs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/NTT/B.txt` & `artistools-2023.5.16.2/artistools/data/filters/NTT/B.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/NTT/I.txt` & `artistools-2023.5.16.2/artistools/data/filters/NTT/I.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/NTT/R.txt` & `artistools-2023.5.16.2/artistools/data/filters/NTT/R.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/NTT/U.txt` & `artistools-2023.5.16.2/artistools/data/filters/NTT/U.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/NTT/V.txt` & `artistools-2023.5.16.2/artistools/data/filters/NTT/V.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/NTT/gs.txt` & `artistools-2023.5.16.2/artistools/data/filters/NTT/gs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/NTT/rs.txt` & `artistools-2023.5.16.2/artistools/data/filters/NTT/rs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/NTT/zs.txt` & `artistools-2023.5.16.2/artistools/data/filters/NTT/zs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/NUV.txt` & `artistools-2023.5.16.2/artistools/data/filters/NUV.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/OGLE/I.txt` & `artistools-2023.5.16.2/artistools/data/filters/OGLE/I.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/OGLE/V.txt` & `artistools-2023.5.16.2/artistools/data/filters/OGLE/V.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/PS1/gs.txt` & `artistools-2023.5.16.2/artistools/data/filters/PS1/gs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/PS1/is.txt` & `artistools-2023.5.16.2/artistools/data/filters/PS1/is.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/PS1/rs.txt` & `artistools-2023.5.16.2/artistools/data/filters/PS1/rs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/PS1/ws.txt` & `artistools-2023.5.16.2/artistools/data/filters/PS1/ws.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/PS1/zs.txt` & `artistools-2023.5.16.2/artistools/data/filters/PS1/zs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/R.txt` & `artistools-2023.5.16.2/artistools/data/filters/R.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/SKYMAPPER/gs.txt` & `artistools-2023.5.16.2/artistools/data/filters/SKYMAPPER/gs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/SKYMAPPER/is.txt` & `artistools-2023.5.16.2/artistools/data/filters/SKYMAPPER/is.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/SKYMAPPER/rs.txt` & `artistools-2023.5.16.2/artistools/data/filters/SKYMAPPER/rs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/SKYMAPPER/us.txt` & `artistools-2023.5.16.2/artistools/data/filters/SKYMAPPER/us.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/SKYMAPPER/zs.txt` & `artistools-2023.5.16.2/artistools/data/filters/SKYMAPPER/zs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/U.txt` & `artistools-2023.5.16.2/artistools/data/filters/U.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/V.txt` & `artistools-2023.5.16.2/artistools/data/filters/V.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/gs.txt` & `artistools-2023.5.16.2/artistools/data/filters/gs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/is.txt` & `artistools-2023.5.16.2/artistools/data/filters/is.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/rs.txt` & `artistools-2023.5.16.2/artistools/data/filters/rs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/us.txt` & `artistools-2023.5.16.2/artistools/data/filters/us.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/uvm2.txt` & `artistools-2023.5.16.2/artistools/data/filters/uvm2.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/uvm2_ab.txt` & `artistools-2023.5.16.2/artistools/data/filters/uvm2_ab.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/uvw1.txt` & `artistools-2023.5.16.2/artistools/data/filters/uvw1.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/uvw1_ab.txt` & `artistools-2023.5.16.2/artistools/data/filters/uvw1_ab.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/uvw2.txt` & `artistools-2023.5.16.2/artistools/data/filters/uvw2.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/uvw2_ab.txt` & `artistools-2023.5.16.2/artistools/data/filters/uvw2_ab.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/filters/zs.txt` & `artistools-2023.5.16.2/artistools/data/filters/zs.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/lightcurves/bollightcurves/AT2017gfo_smarttetal2017.txt` & `artistools-2023.5.16.2/artistools/data/lightcurves/bollightcurves/AT2017gfo_smarttetal2017.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/lightcurves/bollightcurves/AT2017gfo_waxmanetal2018.txt` & `artistools-2023.5.16.2/artistools/data/lightcurves/bollightcurves/AT2017gfo_waxmanetal2018.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/2003du_20031213_3219_8822_00.txt` & `artistools-2023.5.16.2/artistools/data/refspectra/2003du_20031213_3219_8822_00.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/2010lp_20110928_fors2.txt` & `artistools-2023.5.16.2/artistools/data/refspectra/2010lp_20110928_fors2.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/2018byg_2018-05-08_P200_DBSP_None.ascii` & `artistools-2023.5.16.2/artistools/data/refspectra/2018byg_2018-05-08_P200_DBSP_None.ascii`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/2018byg_2018-05-14_Keck1_LRIS_None.ascii` & `artistools-2023.5.16.2/artistools/data/refspectra/2018byg_2018-05-14_Keck1_LRIS_None.ascii`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/2018byg_2018-05-17_P200_DBSP_None.ascii` & `artistools-2023.5.16.2/artistools/data/refspectra/2018byg_2018-05-17_P200_DBSP_None.ascii`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/2018byg_2018-06-03_Keck1_MOSFIRE_None.ascii` & `artistools-2023.5.16.2/artistools/data/refspectra/2018byg_2018-06-03_Keck1_MOSFIRE_None.ascii`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/2018byg_2018-06-08_P200_DBSP_None.ascii` & `artistools-2023.5.16.2/artistools/data/refspectra/2018byg_2018-06-08_P200_DBSP_None.ascii`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/2018byg_2018-06-17_Keck1_LRIS_None.ascii` & `artistools-2023.5.16.2/artistools/data/refspectra/2018byg_2018-06-17_Keck1_LRIS_None.ascii`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/AT2017gfo_ENGRAVE_v1.0_XSHOOTER_MJD-57983.969_Phase+1.43d.dat.xz` & `artistools-2023.5.16.2/artistools/data/refspectra/AT2017gfo_ENGRAVE_v1.0_XSHOOTER_MJD-57983.969_Phase+1.43d.dat.xz`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/AT2017gfo_ENGRAVE_v1.0_XSHOOTER_MJD-57984.969_Phase+2.42d.dat.xz` & `artistools-2023.5.16.2/artistools/data/refspectra/AT2017gfo_ENGRAVE_v1.0_XSHOOTER_MJD-57984.969_Phase+2.42d.dat.xz`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/AT2017gfo_ENGRAVE_v1.0_XSHOOTER_MJD-57985.974_Phase+3.41d.dat.xz` & `artistools-2023.5.16.2/artistools/data/refspectra/AT2017gfo_ENGRAVE_v1.0_XSHOOTER_MJD-57985.974_Phase+3.41d.dat.xz`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/AT2017gfo_ENGRAVE_v1.0_XSHOOTER_MJD-57986.974_Phase+4.40d.dat.xz` & `artistools-2023.5.16.2/artistools/data/refspectra/AT2017gfo_ENGRAVE_v1.0_XSHOOTER_MJD-57986.974_Phase+4.40d.dat.xz`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/AT2017gfo_ENGRAVE_v1.0_XSHOOTER_MJD-57987.980_Phase+5.40d.dat.xz` & `artistools-2023.5.16.2/artistools/data/refspectra/AT2017gfo_ENGRAVE_v1.0_XSHOOTER_MJD-57987.980_Phase+5.40d.dat.xz`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/AT2017gfo_ENGRAVE_v1.0_XSHOOTER_MJD-57988.990_Phase+6.40d.dat.xz` & `artistools-2023.5.16.2/artistools/data/refspectra/AT2017gfo_ENGRAVE_v1.0_XSHOOTER_MJD-57988.990_Phase+6.40d.dat.xz`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/AT2017gfo_ENGRAVE_v1.0_XSHOOTER_MJD-57990.000_Phase+7.40d.dat.xz` & `artistools-2023.5.16.2/artistools/data/refspectra/AT2017gfo_ENGRAVE_v1.0_XSHOOTER_MJD-57990.000_Phase+7.40d.dat.xz`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/AT2017gfo_ENGRAVE_v1.0_XSHOOTER_MJD-57991.000_Phase+8.40d.dat.xz` & `artistools-2023.5.16.2/artistools/data/refspectra/AT2017gfo_ENGRAVE_v1.0_XSHOOTER_MJD-57991.000_Phase+8.40d.dat.xz`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/AT2017gfo_ENGRAVE_v1.0_XSHOOTER_MJD-57992.000_Phase+9.40d.dat.xz` & `artistools-2023.5.16.2/artistools/data/refspectra/AT2017gfo_ENGRAVE_v1.0_XSHOOTER_MJD-57992.000_Phase+9.40d.dat.xz`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/AT2017gfo_ENGRAVE_v1.0_XSHOOTER_MJD-57993.000_Phase+10.40d.dat.xz` & `artistools-2023.5.16.2/artistools/data/refspectra/AT2017gfo_ENGRAVE_v1.0_XSHOOTER_MJD-57993.000_Phase+10.40d.dat.xz`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/FranssonJerkstrand2015_W7_330d_10Mpc.txt` & `artistools-2023.5.16.2/artistools/data/refspectra/FranssonJerkstrand2015_W7_330d_10Mpc.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/PSNJ11492548_20160202_3Ang.txt` & `artistools-2023.5.16.2/artistools/data/refspectra/PSNJ11492548_20160202_3Ang.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/PTF11kly_20120402_norm.dat.txt` & `artistools-2023.5.16.2/artistools/data/refspectra/PTF11kly_20120402_norm.dat.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/SN2013aa_20140216_3Ang.txt` & `artistools-2023.5.16.2/artistools/data/refspectra/SN2013aa_20140216_3Ang.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/SN2013aa_20140421_3Ang.txt` & `artistools-2023.5.16.2/artistools/data/refspectra/SN2013aa_20140421_3Ang.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/SN2013cs_20140325_3Ang.txt` & `artistools-2023.5.16.2/artistools/data/refspectra/SN2013cs_20140325_3Ang.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/SN2013ct_20131119_3Ang.txt` & `artistools-2023.5.16.2/artistools/data/refspectra/SN2013ct_20131119_3Ang.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/maurer2011_RTJ_W7_338d_1Mpc.txt` & `artistools-2023.5.16.2/artistools/data/refspectra/maurer2011_RTJ_W7_338d_1Mpc.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/refspectra/sn2011fe_PTF11kly_20120822_norm.txt` & `artistools-2023.5.16.2/artistools/data/refspectra/sn2011fe_PTF11kly_20120822_norm.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/data/solar_r_abundance_pattern.txt` & `artistools-2023.5.16.2/artistools/data/solar_r_abundance_pattern.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/deposition.py` & `artistools-2023.5.16.2/artistools/deposition.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/estimators/__init__.py` & `artistools-2023.5.16.2/artistools/estimators/__init__.py`
...
### Comparing `artistools-2023.5.16/artistools/estimators/estimators.py` & `artistools-2023.5.16.2/artistools/estimators/estimators.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/estimators/estimators_classic.py` & `artistools-2023.5.16.2/artistools/estimators/estimators_classic.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/estimators/exportmassfractions.py` & `artistools-2023.5.16.2/artistools/estimators/exportmassfractions.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/estimators/plot3destimators_classic.py` & `artistools-2023.5.16.2/artistools/estimators/plot3destimators_classic.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/estimators/plotestimators.py` & `artistools-2023.5.16.2/artistools/estimators/plotestimators.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/gsinetwork.py` & `artistools-2023.5.16.2/artistools/gsinetwork.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/hesma_scripts.py` & `artistools-2023.5.16.2/artistools/hesma_scripts.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/initial_composition.py` & `artistools-2023.5.16.2/artistools/initial_composition.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/1dslicefrom3d.py` & `artistools-2023.5.16.2/artistools/inputmodel/1dslicefrom3d.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/__init__.py` & `artistools-2023.5.16.2/artistools/inputmodel/__init__.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/botyanski2017.py` & `artistools-2023.5.16.2/artistools/inputmodel/botyanski2017.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/describeinputmodel.py` & `artistools-2023.5.16.2/artistools/inputmodel/describeinputmodel.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/downscale3dgrid.py` & `artistools-2023.5.16.2/artistools/inputmodel/downscale3dgrid.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/energyinputfiles.py` & `artistools-2023.5.16.2/artistools/inputmodel/energyinputfiles.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/fromcmfgen/convert_to_artis_neartimezero.py` & `artistools-2023.5.16.2/artistools/inputmodel/fromcmfgen/convert_to_artis_neartimezero.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/fromcmfgen/rd_cmfgen.py` & `artistools-2023.5.16.2/artistools/inputmodel/fromcmfgen/rd_cmfgen.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/fullymixed.py` & `artistools-2023.5.16.2/artistools/inputmodel/fullymixed.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/inputmodel_misc.py` & `artistools-2023.5.16.2/artistools/inputmodel/inputmodel_misc.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/lapuente.py` & `artistools-2023.5.16.2/artistools/inputmodel/lapuente.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/makeartismodel.py` & `artistools-2023.5.16.2/artistools/inputmodel/makeartismodel.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/maketardismodelfromartis.py` & `artistools-2023.5.16.2/artistools/inputmodel/maketardismodelfromartis.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/map_1d_to_3d_grid.py` & `artistools-2023.5.16.2/artistools/inputmodel/map_1d_to_3d_grid.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/maptogrid.py` & `artistools-2023.5.16.2/artistools/inputmodel/maptogrid.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/modelfromhydro.py` & `artistools-2023.5.16.2/artistools/inputmodel/modelfromhydro.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/opacityinputfile.py` & `artistools-2023.5.16.2/artistools/inputmodel/opacityinputfile.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/plotdensity.py` & `artistools-2023.5.16.2/artistools/inputmodel/plotdensity.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/recombinationenergy.py` & `artistools-2023.5.16.2/artistools/inputmodel/recombinationenergy.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/rprocess_from_trajectory.py` & `artistools-2023.5.16.2/artistools/inputmodel/rprocess_from_trajectory.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/rprocess_solar.py` & `artistools-2023.5.16.2/artistools/inputmodel/rprocess_solar.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/scalevelocity.py` & `artistools-2023.5.16.2/artistools/inputmodel/scalevelocity.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/shen2018.py` & `artistools-2023.5.16.2/artistools/inputmodel/shen2018.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/slice1Dfromconein3dmodel.py` & `artistools-2023.5.16.2/artistools/inputmodel/slice1Dfromconein3dmodel.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/inputmodel/test_inputmodel.py` & `artistools-2023.5.16.2/artistools/inputmodel/test_inputmodel.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/lightcurve/__init__.py` & `artistools-2023.5.16.2/artistools/lightcurve/__init__.py`
...
### Comparing `artistools-2023.5.16/artistools/lightcurve/lightcurve.py` & `artistools-2023.5.16.2/artistools/lightcurve/lightcurve.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/lightcurve/plotlightcurve.py` & `artistools-2023.5.16.2/artistools/lightcurve/plotlightcurve.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/lightcurve/test_lightcurve.py` & `artistools-2023.5.16.2/artistools/lightcurve/test_lightcurve.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/lightcurve/viewingangleanalysis.py` & `artistools-2023.5.16.2/artistools/lightcurve/viewingangleanalysis.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/lightcurve/writebollightcurvedata.py` & `artistools-2023.5.16.2/artistools/lightcurve/writebollightcurvedata.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/linefluxes.py` & `artistools-2023.5.16.2/artistools/linefluxes.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/logfiles.py` & `artistools-2023.5.16.2/artistools/logfiles.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/macroatom.py` & `artistools-2023.5.16.2/artistools/macroatom.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/matplotlibrc` & `artistools-2023.5.16.2/artistools/matplotlibrc`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/misc.py` & `artistools-2023.5.16.2/artistools/misc.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/nltepops/nltepops.py` & `artistools-2023.5.16.2/artistools/nltepops/nltepops.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/nltepops/plotnltepops.py` & `artistools-2023.5.16.2/artistools/nltepops/plotnltepops.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/nonthermal/__init__.py` & `artistools-2023.5.16.2/artistools/nonthermal/__init__.py`
...
### Comparing `artistools-2023.5.16/artistools/nonthermal/_nonthermal_core.py` & `artistools-2023.5.16.2/artistools/nonthermal/_nonthermal_core.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/nonthermal/leptontransport.py` & `artistools-2023.5.16.2/artistools/nonthermal/leptontransport.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/nonthermal/plotnonthermal.py` & `artistools-2023.5.16.2/artistools/nonthermal/plotnonthermal.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/nonthermal/solvespencerfanocmd.py` & `artistools-2023.5.16.2/artistools/nonthermal/solvespencerfanocmd.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/packets/__init__.py` & `artistools-2023.5.16.2/artistools/packets/__init__.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/packets/packets.py` & `artistools-2023.5.16.2/artistools/packets/packets.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/packets/packetsplots.py` & `artistools-2023.5.16.2/artistools/packets/packetsplots.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/plotspherical.py` & `artistools-2023.5.16.2/artistools/plotspherical.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/plottools.py` & `artistools-2023.5.16.2/artistools/plottools.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/radfield.py` & `artistools-2023.5.16.2/artistools/radfield.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/spectra/__init__.py` & `artistools-2023.5.16.2/artistools/spectra/__init__.py`
...
### Comparing `artistools-2023.5.16/artistools/spectra/plotspectra.py` & `artistools-2023.5.16.2/artistools/spectra/plotspectra.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/spectra/sampleblackbodyfrompacketTR.py` & `artistools-2023.5.16.2/artistools/spectra/sampleblackbodyfrompacketTR.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/spectra/spectra.py` & `artistools-2023.5.16.2/artistools/spectra/spectra.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/spectra/test_spectra.py` & `artistools-2023.5.16.2/artistools/spectra/test_spectra.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/spectra/test_vspectra.py` & `artistools-2023.5.16.2/artistools/spectra/test_vspectra.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/stats.py` & `artistools-2023.5.16.2/artistools/stats.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/test_artistools.py` & `artistools-2023.5.16.2/artistools/test_artistools.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/transitions.py` & `artistools-2023.5.16.2/artistools/transitions.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/viewing_angles_visualization.py` & `artistools-2023.5.16.2/artistools/viewing_angles_visualization.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools/writecomparisondata.py` & `artistools-2023.5.16.2/artistools/writecomparisondata.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools.egg-info/PKG-INFO` & `artistools-2023.5.16.2/artistools.egg-info/PKG-INFO`
...
### Comparing `artistools-2023.5.16/artistools.egg-info/SOURCES.txt` & `artistools-2023.5.16.2/artistools.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistools.egg-info/entry_points.txt` & `artistools-2023.5.16.2/artistools.egg-info/entry_points.txt`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/artistoolscompletions.sh` & `artistools-2023.5.16.2/artistoolscompletions.sh`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/images/fig-emission.pdf` & `artistools-2023.5.16.2/images/fig-emission.pdf`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/images/fig-emission.png` & `artistools-2023.5.16.2/images/fig-emission.png`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/images/fig-estimators.pdf` & `artistools-2023.5.16.2/images/fig-estimators.pdf`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/images/fig-estimators.png` & `artistools-2023.5.16.2/images/fig-estimators.png`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/images/fig-nlte-Ni.pdf` & `artistools-2023.5.16.2/images/fig-nlte-Ni.pdf`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/images/fig-nlte-Ni.png` & `artistools-2023.5.16.2/images/fig-nlte-Ni.png`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/pyproject.toml` & `artistools-2023.5.16.2/pyproject.toml`
...
### Comparing `artistools-2023.5.16/setup.py` & `artistools-2023.5.16.2/setup.py`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/tests/data/testmodel_3d_10^3/abundances.txt.xz` & `artistools-2023.5.16.2/tests/data/testmodel_3d_10^3/abundances.txt.xz`

 * *Files identical despite different names*

### Comparing `artistools-2023.5.16/tests/data/testmodel_3d_10^3/model.txt.xz` & `artistools-2023.5.16.2/tests/data/testmodel_3d_10^3/model.txt.xz`
