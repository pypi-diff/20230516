# Comparing `tmp/swibots-1.1.5.tar.gz` & `tmp/swibots-1.1.6.tar.gz`
...
### Comparing `swibots-1.1.5/swibots/api/bot/models/bot_command_info.py` & `swibots-1.1.6/swibots/api/bot/models/bot_command_info.py`
...
### Comparing `swibots-1.1.5/swibots/api/community/events/channel_deleted_event.py` & `swibots-1.1.6/swibots/api/community/events/group_updated_event.py`
...
### Comparing `swibots-1.1.5/swibots/api/community/events/channel_updated_event.py` & `swibots-1.1.6/swibots/api/community/events/user_banned_event.py`
...
### Comparing `swibots-1.1.5/swibots/api/community/events/community_event.py` & `swibots-1.1.6/swibots/api/community/events/community_event.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/api/community/events/community_updated_event.py` & `swibots-1.1.6/swibots/api/community/events/member_joined_event.py`
...
### Comparing `swibots-1.1.5/swibots/api/community/events/group_created_event.py` & `swibots-1.1.6/swibots/api/community/events/group_deleted_event.py`
...
### Comparing `swibots-1.1.5/swibots/api/community/events/member_left_event.py` & `swibots-1.1.6/swibots/api/community/events/member_left_event.py`
...
### Comparing `swibots-1.1.5/swibots/api/community/methods/get_channel.py` & `swibots-1.1.6/swibots/api/community/methods/get_channel.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/api/community/methods/get_community.py` & `swibots-1.1.6/swibots/api/community/methods/get_community.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/api/community/methods/get_group.py` & `swibots-1.1.6/swibots/api/community/methods/get_group.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/api/community/models/channel.py` & `swibots-1.1.6/swibots/api/community/models/channel.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/api/community/models/community.py` & `swibots-1.1.6/swibots/api/community/models/community.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/api/community/models/group.py` & `swibots-1.1.6/swibots/api/community/models/group.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/app.py` & `swibots-1.1.6/swibots/app.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/base/rest_response.py` & `swibots-1.1.6/swibots/base/rest_response.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/base/switch_client.py` & `swibots-1.1.6/swibots/base/switch_client.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/base/switch_object.py` & `swibots-1.1.6/swibots/base/switch_object.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/base/switch_ws_async_client.py` & `swibots-1.1.6/swibots/base/switch_ws_async_client.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/bot_app.py` & `swibots-1.1.6/swibots/bot_app.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/bots/bot.py` & `swibots-1.1.6/swibots/bots/bot.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/bots/bot_context.py` & `swibots-1.1.6/swibots/bots/bot_context.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/bots/decorators/__init__.py` & `swibots-1.1.6/swibots/bots/decorators/__init__.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/bots/decorators/on_callback_query.py` & `swibots-1.1.6/swibots/bots/decorators/on_callback_query.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/bots/decorators/on_channel_deleted.py` & `swibots-1.1.6/swibots/bots/decorators/on_channel_deleted.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/bots/decorators/on_channel_updated.py` & `swibots-1.1.6/swibots/bots/decorators/on_channel_updated.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/bots/decorators/on_command.py` & `swibots-1.1.6/swibots/bots/decorators/on_command.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/bots/decorators/on_community_updated.py` & `swibots-1.1.6/swibots/bots/decorators/on_community_updated.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/bots/decorators/on_group_created.py` & `swibots-1.1.6/swibots/bots/decorators/on_group_created.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/bots/decorators/on_group_deleted.py` & `swibots-1.1.6/swibots/bots/decorators/on_group_deleted.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/bots/decorators/on_group_updated.py` & `swibots-1.1.6/swibots/bots/decorators/on_group_updated.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/bots/decorators/on_inline_query.py` & `swibots-1.1.6/swibots/bots/decorators/on_inline_query.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/bots/decorators/on_member_joined.py` & `swibots-1.1.6/swibots/bots/decorators/on_member_joined.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/bots/decorators/on_member_left.py` & `swibots-1.1.6/swibots/bots/decorators/on_member_left.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/bots/decorators/on_unknown_command.py` & `swibots-1.1.6/swibots/bots/decorators/on_unknown_command.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/bots/filters/filter.py` & `swibots-1.1.6/swibots/bots/filters/filter.py`
...
### Comparing `swibots-1.1.5/swibots/bots/handlers/__init__.py` & `swibots-1.1.6/swibots/bots/handlers/__init__.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/bots/handlers/base_handler.py` & `swibots-1.1.6/swibots/bots/handlers/base_handler.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/bots/handlers/callback_query_handler.py` & `swibots-1.1.6/swibots/bots/handlers/callback_query_handler.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/bots/handlers/channel_created_handler.py` & `swibots-1.1.6/swibots/bots/handlers/community_updated_handler.py`
...
### Comparing `swibots-1.1.5/swibots/bots/handlers/channel_deleted_handler.py` & `swibots-1.1.6/swibots/bots/handlers/inline_query_handler.py`
...
### Comparing `swibots-1.1.5/swibots/bots/handlers/channel_updated_handler.py` & `swibots-1.1.6/swibots/bots/handlers/group_deleted_handler.py`
...
### Comparing `swibots-1.1.5/swibots/bots/handlers/command_handler.py` & `swibots-1.1.6/swibots/bots/handlers/command_handler.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/bots/handlers/community_updated_handler.py` & `swibots-1.1.6/swibots/bots/handlers/member_joined_handler.py`
...
### Comparing `swibots-1.1.5/swibots/bots/handlers/event_handler.py` & `swibots-1.1.6/swibots/bots/handlers/event_handler.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/bots/handlers/group_created_handler.py` & `swibots-1.1.6/swibots/bots/handlers/group_created_handler.py`
...
### Comparing `swibots-1.1.5/swibots/bots/handlers/group_deleted_handler.py` & `swibots-1.1.6/swibots/bots/handlers/group_updated_handler.py`
...
### Comparing `swibots-1.1.5/swibots/bots/handlers/group_updated_handler.py` & `swibots-1.1.6/swibots/bots/handlers/channel_created_handler.py`
...
### Comparing `swibots-1.1.5/swibots/bots/handlers/inline_query_handler.py` & `swibots-1.1.6/swibots/bots/handlers/message_handler.py`
...
### Comparing `swibots-1.1.5/swibots/bots/handlers/member_joined_handler.py` & `swibots-1.1.6/swibots/bots/handlers/unknown_command_handler.py`
...
### Comparing `swibots-1.1.5/swibots/bots/handlers/member_left_handler.py` & `swibots-1.1.6/swibots/bots/handlers/channel_updated_handler.py`
...
### Comparing `swibots-1.1.5/swibots/bots/handlers/user_banned_handler.py` & `swibots-1.1.6/swibots/bots/handlers/member_left_handler.py`
...
### Comparing `swibots-1.1.5/swibots/error.py` & `swibots-1.1.6/swibots/error.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/types.py` & `swibots-1.1.6/swibots/types.py`
...
### Comparing `swibots-1.1.5/swibots/utils/rest_client.py` & `swibots-1.1.6/swibots/utils/rest_client.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/utils/types.py` & `swibots-1.1.6/swibots/utils/types.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/utils/ws/asyncstomp/async_ws_client.py` & `swibots-1.1.6/swibots/utils/ws/asyncstomp/async_ws_client.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/utils/ws/asyncstomp/async_ws_subscription.py` & `swibots-1.1.6/swibots/utils/ws/asyncstomp/async_ws_subscription.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots/utils/ws/common/ws_frame.py` & `swibots-1.1.6/swibots/utils/ws/common/ws_frame.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.5/swibots.egg-info/SOURCES.txt` & `swibots-1.1.6/swibots.egg-info/SOURCES.txt`
