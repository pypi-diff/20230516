# Comparing `tmp/pretext-1.5.3.dev20230514.tar.gz` & `tmp/pretext-1.5.3.dev20230515.tar.gz`
...
## Comparing `pretext-1.5.3.dev20230514.tar` & `pretext-1.5.3.dev20230515.tar`
...
### Comparing `pretext-1.5.3.dev20230514/LICENSE` & `pretext-1.5.3.dev20230515/LICENSE`

 * *Files identical despite different names*

### Comparing `pretext-1.5.3.dev20230514/README.md` & `pretext-1.5.3.dev20230515/README.md`

 * *Files identical despite different names*

### Comparing `pretext-1.5.3.dev20230514/pretext/__init__.py` & `pretext-1.5.3.dev20230515/pretext/__init__.py`

 * *Files identical despite different names*

### Comparing `pretext-1.5.3.dev20230514/pretext/build.py` & `pretext-1.5.3.dev20230515/pretext/build.py`

 * *Files identical despite different names*

### Comparing `pretext-1.5.3.dev20230514/pretext/cli.py` & `pretext-1.5.3.dev20230515/pretext/cli.py`

 * *Files identical despite different names*

### Comparing `pretext-1.5.3.dev20230514/pretext/codechat.py` & `pretext-1.5.3.dev20230515/pretext/codechat.py`

 * *Files identical despite different names*

### Comparing `pretext-1.5.3.dev20230514/pretext/config/xml_overlay.py` & `pretext-1.5.3.dev20230515/pretext/config/xml_overlay.py`

 * *Files identical despite different names*

### Comparing `pretext-1.5.3.dev20230514/pretext/core/pretext.py` & `pretext-1.5.3.dev20230515/pretext/core/pretext.py`

 * *Files identical despite different names*

### Comparing `pretext-1.5.3.dev20230514/pretext/core/resources.py` & `pretext-1.5.3.dev20230515/pretext/core/resources.py`

 * *Files identical despite different names*

### Comparing `pretext-1.5.3.dev20230514/pretext/core/resources.zip` & `pretext-1.5.3.dev20230515/pretext/core/resources.zip`
...
### Comparing `pretext-1.5.3.dev20230514/pretext/generate.py` & `pretext-1.5.3.dev20230515/pretext/generate.py`

 * *Files identical despite different names*

### Comparing `pretext-1.5.3.dev20230514/pretext/project.py` & `pretext-1.5.3.dev20230515/pretext/project.py`

 * *Files identical despite different names*

### Comparing `pretext-1.5.3.dev20230514/pretext/templates/__init__.py` & `pretext-1.5.3.dev20230515/pretext/templates/__init__.py`

 * *Files identical despite different names*

### Comparing `pretext-1.5.3.dev20230514/pretext/templates/resources/.gitignore` & `pretext-1.5.3.dev20230515/pretext/templates/resources/.gitignore`

 * *Files identical despite different names*

### Comparing `pretext-1.5.3.dev20230514/pretext/templates/resources/article.zip` & `pretext-1.5.3.dev20230515/pretext/templates/resources/article.zip`
...
### Comparing `pretext-1.5.3.dev20230514/pretext/templates/resources/book.zip` & `pretext-1.5.3.dev20230515/pretext/templates/resources/book.zip`
...
### Comparing `pretext-1.5.3.dev20230514/pretext/templates/resources/demo.zip` & `pretext-1.5.3.dev20230515/pretext/templates/resources/demo.zip`
...
### Comparing `pretext-1.5.3.dev20230514/pretext/templates/resources/devcontainer.json` & `pretext-1.5.3.dev20230515/pretext/templates/resources/devcontainer.json`

 * *Files identical despite different names*

### Comparing `pretext-1.5.3.dev20230514/pretext/templates/resources/hello.zip` & `pretext-1.5.3.dev20230515/pretext/templates/resources/hello.zip`
...
### Comparing `pretext-1.5.3.dev20230514/pretext/templates/resources/postCreateCommand.sh` & `pretext-1.5.3.dev20230515/pretext/templates/resources/postCreateCommand.sh`

 * *Files identical despite different names*

### Comparing `pretext-1.5.3.dev20230514/pretext/templates/resources/project.ptx` & `pretext-1.5.3.dev20230515/pretext/templates/resources/project.ptx`

 * *Files identical despite different names*

### Comparing `pretext-1.5.3.dev20230514/pretext/templates/resources/slideshow.zip` & `pretext-1.5.3.dev20230515/pretext/templates/resources/slideshow.zip`
...
### Comparing `pretext-1.5.3.dev20230514/pretext/utils.py` & `pretext-1.5.3.dev20230515/pretext/utils.py`

 * *Files identical despite different names*

### Comparing `pretext-1.5.3.dev20230514/pyproject.toml` & `pretext-1.5.3.dev20230515/pyproject.toml`
...
### Comparing `pretext-1.5.3.dev20230514/PKG-INFO` & `pretext-1.5.3.dev20230515/PKG-INFO`
