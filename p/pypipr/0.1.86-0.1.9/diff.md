# Comparing `tmp/pypipr-0.1.86.tar.gz` & `tmp/pypipr-0.1.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "pypipr-0.1.86.tar", max compression
+gzip compressed data, was "pypipr-0.1.9.tar", max compression
```

## Comparing `pypipr-0.1.86.tar` & `pypipr-0.1.9.tar`

### file list

```diff
@@ -1,6 +1,9 @@
--rw-r--r--   0        0        0        0 2022-10-24 06:22:00.291550 pypipr-0.1.86/pypipr/__init__.py
--rw-r--r--   0        0        0    32951 2023-05-16 05:36:55.274875 pypipr-0.1.86/pypipr/pypipr.py
--rw-r--r--   0        0        0      615 2023-05-16 05:50:17.041772 pypipr-0.1.86/pyproject.toml
--rw-r--r--   0        0        0    13328 2023-05-16 05:49:52.949357 pypipr-0.1.86/README.md
--rw-r--r--   0        0        0    14232 1970-01-01 00:00:00.000000 pypipr-0.1.86/setup.py
--rw-r--r--   0        0        0    13274 1970-01-01 00:00:00.000000 pypipr-0.1.86/PKG-INFO
