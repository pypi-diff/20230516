# Comparing `tmp/questdb-connect-0.0.49.tar.gz` & `tmp/questdb-connect-0.0.50.tar.gz`
...
### Comparing `questdb-connect-0.0.49/src/questdb_connect/types.py` & `questdb-connect-0.0.50/src/questdb_connect/types.py`
