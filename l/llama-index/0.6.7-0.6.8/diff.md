# Comparing `tmp/llama_index-0.6.7.tar.gz` & `tmp/llama_index-0.6.8.tar.gz`
...
### Comparing `llama_index-0.6.7/LICENSE` & `llama_index-0.6.8/LICENSE`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/PKG-INFO` & `llama_index-0.6.8/PKG-INFO`
...
### Comparing `llama_index-0.6.7/README.md` & `llama_index-0.6.8/README.md`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/__init__.py` & `llama_index-0.6.8/llama_index/__init__.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/callbacks/aim.py` & `llama_index-0.6.8/llama_index/callbacks/aim.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/callbacks/base.py` & `llama_index-0.6.8/llama_index/callbacks/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/callbacks/llama_debug.py` & `llama_index-0.6.8/llama_index/callbacks/llama_debug.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/callbacks/schema.py` & `llama_index-0.6.8/llama_index/callbacks/schema.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/composability/joint_qa_summary.py` & `llama_index-0.6.8/llama_index/composability/joint_qa_summary.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/data_structs/data_structs.py` & `llama_index-0.6.8/llama_index/data_structs/data_structs.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/data_structs/document_summary.py` & `llama_index-0.6.8/llama_index/data_structs/document_summary.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/data_structs/node.py` & `llama_index-0.6.8/llama_index/data_structs/node.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/data_structs/registry.py` & `llama_index-0.6.8/llama_index/data_structs/registry.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/data_structs/struct_type.py` & `llama_index-0.6.8/llama_index/data_structs/struct_type.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/data_structs/table.py` & `llama_index-0.6.8/llama_index/data_structs/table.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/embeddings/base.py` & `llama_index-0.6.8/llama_index/embeddings/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/embeddings/google.py` & `llama_index-0.6.8/llama_index/embeddings/google.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/embeddings/langchain.py` & `llama_index-0.6.8/llama_index/embeddings/langchain.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/embeddings/openai.py` & `llama_index-0.6.8/llama_index/embeddings/openai.py`
...
### Comparing `llama_index-0.6.7/llama_index/embeddings/utils.py` & `llama_index-0.6.8/llama_index/embeddings/utils.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/evaluation/base.py` & `llama_index-0.6.8/llama_index/evaluation/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/evaluation/dataset_generation.py` & `llama_index-0.6.8/llama_index/evaluation/dataset_generation.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/img_utils.py` & `llama_index-0.6.8/llama_index/img_utils.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/__init__.py` & `llama_index-0.6.8/llama_index/indices/__init__.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/base.py` & `llama_index-0.6.8/llama_index/indices/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/base_retriever.py` & `llama_index-0.6.8/llama_index/indices/base_retriever.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/common/struct_store/base.py` & `llama_index-0.6.8/llama_index/indices/common/struct_store/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/common/struct_store/schema.py` & `llama_index-0.6.8/llama_index/indices/common/struct_store/schema.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/common/struct_store/sql.py` & `llama_index-0.6.8/llama_index/indices/common/struct_store/sql.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/common_tree/base.py` & `llama_index-0.6.8/llama_index/indices/common_tree/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/composability/graph.py` & `llama_index-0.6.8/llama_index/indices/composability/graph.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/document_summary/base.py` & `llama_index-0.6.8/llama_index/indices/document_summary/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/document_summary/retrievers.py` & `llama_index-0.6.8/llama_index/indices/document_summary/retrievers.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/empty/base.py` & `llama_index-0.6.8/llama_index/indices/empty/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/empty/retrievers.py` & `llama_index-0.6.8/llama_index/indices/empty/retrievers.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/keyword_table/__init__.py` & `llama_index-0.6.8/llama_index/indices/keyword_table/__init__.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/keyword_table/base.py` & `llama_index-0.6.8/llama_index/indices/keyword_table/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/keyword_table/rake_base.py` & `llama_index-0.6.8/llama_index/indices/keyword_table/rake_base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/keyword_table/retrievers.py` & `llama_index-0.6.8/llama_index/indices/keyword_table/retrievers.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/keyword_table/simple_base.py` & `llama_index-0.6.8/llama_index/indices/keyword_table/simple_base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/keyword_table/utils.py` & `llama_index-0.6.8/llama_index/indices/keyword_table/utils.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/knowledge_graph/base.py` & `llama_index-0.6.8/llama_index/indices/knowledge_graph/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/knowledge_graph/retrievers.py` & `llama_index-0.6.8/llama_index/indices/knowledge_graph/retrievers.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/list/base.py` & `llama_index-0.6.8/llama_index/indices/list/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/list/retrievers.py` & `llama_index-0.6.8/llama_index/indices/list/retrievers.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/loading.py` & `llama_index-0.6.8/llama_index/indices/loading.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/postprocessor/__init__.py` & `llama_index-0.6.8/llama_index/indices/postprocessor/__init__.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/postprocessor/cohere_rerank.py` & `llama_index-0.6.8/llama_index/indices/postprocessor/cohere_rerank.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/postprocessor/llm_rerank.py` & `llama_index-0.6.8/llama_index/indices/postprocessor/llm_rerank.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/postprocessor/node.py` & `llama_index-0.6.8/llama_index/indices/postprocessor/node.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/postprocessor/node_recency.py` & `llama_index-0.6.8/llama_index/indices/postprocessor/node_recency.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/postprocessor/pii.py` & `llama_index-0.6.8/llama_index/indices/postprocessor/pii.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/prompt_helper.py` & `llama_index-0.6.8/llama_index/indices/prompt_helper.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/query/base.py` & `llama_index-0.6.8/llama_index/indices/query/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/query/embedding_utils.py` & `llama_index-0.6.8/llama_index/indices/query/embedding_utils.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/query/query_transform/base.py` & `llama_index-0.6.8/llama_index/indices/query/query_transform/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/query/query_transform/prompts.py` & `llama_index-0.6.8/llama_index/indices/query/query_transform/prompts.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/query/response_synthesis.py` & `llama_index-0.6.8/llama_index/indices/query/response_synthesis.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/query/schema.py` & `llama_index-0.6.8/llama_index/indices/query/schema.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/registry.py` & `llama_index-0.6.8/llama_index/indices/registry.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/response/response_builder.py` & `llama_index-0.6.8/llama_index/indices/response/response_builder.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/service_context.py` & `llama_index-0.6.8/llama_index/indices/service_context.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/struct_store/__init__.py` & `llama_index-0.6.8/llama_index/indices/struct_store/__init__.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/struct_store/base.py` & `llama_index-0.6.8/llama_index/indices/struct_store/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/struct_store/container_builder.py` & `llama_index-0.6.8/llama_index/indices/struct_store/container_builder.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/struct_store/pandas.py` & `llama_index-0.6.8/llama_index/indices/struct_store/pandas.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/struct_store/pandas_query.py` & `llama_index-0.6.8/llama_index/indices/struct_store/pandas_query.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/struct_store/sql.py` & `llama_index-0.6.8/llama_index/indices/struct_store/sql.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/struct_store/sql_query.py` & `llama_index-0.6.8/llama_index/indices/struct_store/sql_query.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/tree/__init__.py` & `llama_index-0.6.8/llama_index/indices/tree/__init__.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/tree/all_leaf_retriever.py` & `llama_index-0.6.8/llama_index/indices/tree/all_leaf_retriever.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/tree/base.py` & `llama_index-0.6.8/llama_index/indices/tree/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/tree/inserter.py` & `llama_index-0.6.8/llama_index/indices/tree/inserter.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/tree/select_leaf_embedding_retriever.py` & `llama_index-0.6.8/llama_index/indices/tree/select_leaf_embedding_retriever.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/tree/select_leaf_retriever.py` & `llama_index-0.6.8/llama_index/indices/tree/select_leaf_retriever.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/tree/tree_root_retriever.py` & `llama_index-0.6.8/llama_index/indices/tree/tree_root_retriever.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/utils.py` & `llama_index-0.6.8/llama_index/indices/utils.py`
...
### Comparing `llama_index-0.6.7/llama_index/indices/vector_store/base.py` & `llama_index-0.6.8/llama_index/indices/vector_store/base.py`
...
### Comparing `llama_index-0.6.7/llama_index/indices/vector_store/retrievers/auto_retriever/auto_retriever.py` & `llama_index-0.6.8/llama_index/indices/vector_store/retrievers/auto_retriever/auto_retriever.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/vector_store/retrievers/auto_retriever/output_parser.py` & `llama_index-0.6.8/llama_index/indices/vector_store/retrievers/auto_retriever/output_parser.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/vector_store/retrievers/auto_retriever/prompts.py` & `llama_index-0.6.8/llama_index/indices/vector_store/retrievers/auto_retriever/prompts.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/indices/vector_store/retrievers/retriever.py` & `llama_index-0.6.8/llama_index/indices/vector_store/retrievers/retriever.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/langchain_helpers/agents/__init__.py` & `llama_index-0.6.8/llama_index/langchain_helpers/agents/__init__.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/langchain_helpers/agents/agents.py` & `llama_index-0.6.8/llama_index/langchain_helpers/agents/agents.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/langchain_helpers/agents/toolkits.py` & `llama_index-0.6.8/llama_index/langchain_helpers/agents/toolkits.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/langchain_helpers/agents/tools.py` & `llama_index-0.6.8/llama_index/langchain_helpers/agents/tools.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/langchain_helpers/memory_wrapper.py` & `llama_index-0.6.8/llama_index/langchain_helpers/memory_wrapper.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/langchain_helpers/sql_wrapper.py` & `llama_index-0.6.8/llama_index/langchain_helpers/sql_wrapper.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/langchain_helpers/streaming.py` & `llama_index-0.6.8/llama_index/langchain_helpers/streaming.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/langchain_helpers/text_splitter.py` & `llama_index-0.6.8/llama_index/langchain_helpers/text_splitter.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/llm_predictor/base.py` & `llama_index-0.6.8/llama_index/llm_predictor/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/llm_predictor/chatgpt.py` & `llama_index-0.6.8/llama_index/llm_predictor/chatgpt.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/llm_predictor/huggingface.py` & `llama_index-0.6.8/llama_index/llm_predictor/huggingface.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/llm_predictor/structured.py` & `llama_index-0.6.8/llama_index/llm_predictor/structured.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/logger/base.py` & `llama_index-0.6.8/llama_index/logger/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/node_parser/interface.py` & `llama_index-0.6.8/llama_index/node_parser/interface.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/node_parser/node_utils.py` & `llama_index-0.6.8/llama_index/node_parser/node_utils.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/node_parser/simple.py` & `llama_index-0.6.8/llama_index/node_parser/simple.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/optimization/optimizer.py` & `llama_index-0.6.8/llama_index/optimization/optimizer.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/output_parsers/base.py` & `llama_index-0.6.8/llama_index/output_parsers/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/output_parsers/guardrails.py` & `llama_index-0.6.8/llama_index/output_parsers/guardrails.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/output_parsers/langchain.py` & `llama_index-0.6.8/llama_index/output_parsers/langchain.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/output_parsers/selection.py` & `llama_index-0.6.8/llama_index/output_parsers/selection.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/playground/base.py` & `llama_index-0.6.8/llama_index/playground/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/prompts/base.py` & `llama_index-0.6.8/llama_index/prompts/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/prompts/chat_prompts.py` & `llama_index-0.6.8/llama_index/prompts/chat_prompts.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/prompts/choice_select.py` & `llama_index-0.6.8/llama_index/prompts/choice_select.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/prompts/default_choice_select.py` & `llama_index-0.6.8/llama_index/prompts/default_choice_select.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/prompts/default_prompt_selectors.py` & `llama_index-0.6.8/llama_index/prompts/default_prompt_selectors.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/prompts/default_prompts.py` & `llama_index-0.6.8/llama_index/prompts/default_prompts.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/prompts/prompt_type.py` & `llama_index-0.6.8/llama_index/prompts/prompt_type.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/prompts/prompts.py` & `llama_index-0.6.8/llama_index/prompts/prompts.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/query_engine/__init__.py` & `llama_index-0.6.8/llama_index/query_engine/__init__.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/query_engine/graph_query_engine.py` & `llama_index-0.6.8/llama_index/query_engine/graph_query_engine.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/query_engine/multistep_query_engine.py` & `llama_index-0.6.8/llama_index/query_engine/multistep_query_engine.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/query_engine/retriever_query_engine.py` & `llama_index-0.6.8/llama_index/query_engine/retriever_query_engine.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/query_engine/router_query_engine.py` & `llama_index-0.6.8/llama_index/query_engine/router_query_engine.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/query_engine/transform_query_engine.py` & `llama_index-0.6.8/llama_index/query_engine/transform_query_engine.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/__init__.py` & `llama_index-0.6.8/llama_index/readers/__init__.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/base.py` & `llama_index-0.6.8/llama_index/readers/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/chatgpt_plugin/base.py` & `llama_index-0.6.8/llama_index/readers/chatgpt_plugin/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/chroma.py` & `llama_index-0.6.8/llama_index/readers/chroma.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/database.py` & `llama_index-0.6.8/llama_index/readers/database.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/deeplake.py` & `llama_index-0.6.8/llama_index/readers/deeplake.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/discord_reader.py` & `llama_index-0.6.8/llama_index/readers/discord_reader.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/download.py` & `llama_index-0.6.8/llama_index/readers/download.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/elasticsearch.py` & `llama_index-0.6.8/llama_index/readers/elasticsearch.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/faiss.py` & `llama_index-0.6.8/llama_index/readers/faiss.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/file/docs_parser.py` & `llama_index-0.6.8/llama_index/readers/file/docs_reader.py`
...
### Comparing `llama_index-0.6.7/llama_index/readers/file/image_caption_parser.py` & `llama_index-0.6.8/llama_index/readers/file/image_caption_reader.py`
...
### Comparing `llama_index-0.6.7/llama_index/readers/file/image_parser.py` & `llama_index-0.6.8/llama_index/readers/file/image_reader.py`
...
### Comparing `llama_index-0.6.7/llama_index/readers/file/image_vision_llm_parser.py` & `llama_index-0.6.8/llama_index/readers/file/image_vision_llm_reader.py`
...
### Comparing `llama_index-0.6.7/llama_index/readers/file/markdown_parser.py` & `llama_index-0.6.8/llama_index/readers/file/markdown_reader.py`
...
### Comparing `llama_index-0.6.7/llama_index/readers/file/mbox_parser.py` & `llama_index-0.6.8/llama_index/readers/file/mbox_reader.py`
...
### Comparing `llama_index-0.6.7/llama_index/readers/file/slides_parser.py` & `llama_index-0.6.8/llama_index/readers/file/slides_reader.py`
...
### Comparing `llama_index-0.6.7/llama_index/readers/file/tabular_parser.py` & `llama_index-0.6.8/llama_index/readers/file/tabular_reader.py`
...
### Comparing `llama_index-0.6.7/llama_index/readers/github_readers/github_api_client.py` & `llama_index-0.6.8/llama_index/readers/github_readers/github_api_client.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/github_readers/github_repository_reader.py` & `llama_index-0.6.8/llama_index/readers/github_readers/github_repository_reader.py`
...
### Comparing `llama_index-0.6.7/llama_index/readers/github_readers/utils.py` & `llama_index-0.6.8/llama_index/readers/github_readers/utils.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/google_readers/gdocs.py` & `llama_index-0.6.8/llama_index/readers/google_readers/gdocs.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/google_readers/gsheets.py` & `llama_index-0.6.8/llama_index/readers/google_readers/gsheets.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/json.py` & `llama_index-0.6.8/llama_index/readers/json.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/make_com/wrapper.py` & `llama_index-0.6.8/llama_index/readers/make_com/wrapper.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/mbox.py` & `llama_index-0.6.8/llama_index/readers/mbox.py`
...
### Comparing `llama_index-0.6.7/llama_index/readers/metal.py` & `llama_index-0.6.8/llama_index/readers/metal.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/milvus.py` & `llama_index-0.6.8/llama_index/readers/milvus.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/mongo.py` & `llama_index-0.6.8/llama_index/readers/mongo.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/myscale.py` & `llama_index-0.6.8/llama_index/readers/myscale.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/notion.py` & `llama_index-0.6.8/llama_index/readers/notion.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/obsidian.py` & `llama_index-0.6.8/llama_index/readers/obsidian.py`
...
### Comparing `llama_index-0.6.7/llama_index/readers/pinecone.py` & `llama_index-0.6.8/llama_index/readers/pinecone.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/qdrant.py` & `llama_index-0.6.8/llama_index/readers/qdrant.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/redis/utils.py` & `llama_index-0.6.8/llama_index/readers/redis/utils.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/schema/base.py` & `llama_index-0.6.8/llama_index/readers/schema/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/slack.py` & `llama_index-0.6.8/llama_index/readers/slack.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/steamship/file_reader.py` & `llama_index-0.6.8/llama_index/readers/steamship/file_reader.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/string_iterable.py` & `llama_index-0.6.8/llama_index/readers/string_iterable.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/twitter.py` & `llama_index-0.6.8/llama_index/readers/twitter.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/weaviate/client.py` & `llama_index-0.6.8/llama_index/readers/weaviate/client.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/weaviate/reader.py` & `llama_index-0.6.8/llama_index/readers/weaviate/reader.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/weaviate/utils.py` & `llama_index-0.6.8/llama_index/readers/weaviate/utils.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/web.py` & `llama_index-0.6.8/llama_index/readers/web.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/wikipedia.py` & `llama_index-0.6.8/llama_index/readers/wikipedia.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/readers/youtube_transcript.py` & `llama_index-0.6.8/llama_index/readers/youtube_transcript.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/response/notebook_utils.py` & `llama_index-0.6.8/llama_index/response/notebook_utils.py`
...
### Comparing `llama_index-0.6.7/llama_index/response/pprint_utils.py` & `llama_index-0.6.8/llama_index/response/pprint_utils.py`
...
### Comparing `llama_index-0.6.7/llama_index/response/schema.py` & `llama_index-0.6.8/llama_index/response/schema.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/retrievers/__init__.py` & `llama_index-0.6.8/llama_index/retrievers/__init__.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/retrievers/transform_retriever.py` & `llama_index-0.6.8/llama_index/retrievers/transform_retriever.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/schema.py` & `llama_index-0.6.8/llama_index/schema.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/selectors/llm_selectors.py` & `llama_index-0.6.8/llama_index/selectors/llm_selectors.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/selectors/prompts.py` & `llama_index-0.6.8/llama_index/selectors/prompts.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/selectors/types.py` & `llama_index-0.6.8/llama_index/selectors/types.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/storage/docstore/__init__.py` & `llama_index-0.6.8/llama_index/storage/docstore/__init__.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/storage/docstore/keyval_docstore.py` & `llama_index-0.6.8/llama_index/storage/docstore/keyval_docstore.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/storage/docstore/mongo_docstore.py` & `llama_index-0.6.8/llama_index/storage/docstore/mongo_docstore.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/storage/docstore/registry.py` & `llama_index-0.6.8/llama_index/storage/docstore/registry.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/storage/docstore/simple_docstore.py` & `llama_index-0.6.8/llama_index/storage/docstore/simple_docstore.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/storage/docstore/types.py` & `llama_index-0.6.8/llama_index/storage/docstore/types.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/storage/docstore/utils.py` & `llama_index-0.6.8/llama_index/storage/docstore/utils.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/storage/index_store/keyval_index_store.py` & `llama_index-0.6.8/llama_index/storage/index_store/keyval_index_store.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/storage/index_store/mongo_index_store.py` & `llama_index-0.6.8/llama_index/storage/index_store/mongo_index_store.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/storage/index_store/simple_index_store.py` & `llama_index-0.6.8/llama_index/storage/index_store/simple_index_store.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/storage/index_store/types.py` & `llama_index-0.6.8/llama_index/storage/index_store/types.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/storage/index_store/utils.py` & `llama_index-0.6.8/llama_index/storage/index_store/utils.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/storage/kvstore/mongodb_kvstore.py` & `llama_index-0.6.8/llama_index/storage/kvstore/mongodb_kvstore.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/storage/kvstore/simple_kvstore.py` & `llama_index-0.6.8/llama_index/storage/kvstore/simple_kvstore.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/storage/kvstore/types.py` & `llama_index-0.6.8/llama_index/storage/kvstore/types.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/storage/storage_context.py` & `llama_index-0.6.8/llama_index/storage/storage_context.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/token_counter/mock_chain_wrapper.py` & `llama_index-0.6.8/llama_index/token_counter/mock_chain_wrapper.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/token_counter/mock_embed_model.py` & `llama_index-0.6.8/llama_index/token_counter/mock_embed_model.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/token_counter/token_counter.py` & `llama_index-0.6.8/llama_index/token_counter/token_counter.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/token_counter/utils.py` & `llama_index-0.6.8/llama_index/token_counter/utils.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/tools/query_engine.py` & `llama_index-0.6.8/llama_index/tools/query_engine.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/tts/bark.py` & `llama_index-0.6.8/llama_index/tts/bark.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/tts/base.py` & `llama_index-0.6.8/llama_index/tts/base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/tts/elevenlabs.py` & `llama_index-0.6.8/llama_index/tts/elevenlabs.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/utils.py` & `llama_index-0.6.8/llama_index/utils.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/vector_stores/__init__.py` & `llama_index-0.6.8/llama_index/vector_stores/__init__.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/vector_stores/chatgpt_plugin.py` & `llama_index-0.6.8/llama_index/vector_stores/chatgpt_plugin.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/vector_stores/chroma.py` & `llama_index-0.6.8/llama_index/vector_stores/chroma.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/vector_stores/deeplake.py` & `llama_index-0.6.8/llama_index/vector_stores/deeplake.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/vector_stores/faiss.py` & `llama_index-0.6.8/llama_index/vector_stores/faiss.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/vector_stores/lancedb.py` & `llama_index-0.6.8/llama_index/vector_stores/lancedb.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/vector_stores/metal.py` & `llama_index-0.6.8/llama_index/vector_stores/metal.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/vector_stores/milvus.py` & `llama_index-0.6.8/llama_index/vector_stores/milvus.py`
...
### Comparing `llama_index-0.6.7/llama_index/vector_stores/myscale.py` & `llama_index-0.6.8/llama_index/vector_stores/myscale.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/vector_stores/opensearch.py` & `llama_index-0.6.8/llama_index/vector_stores/opensearch.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/vector_stores/pinecone.py` & `llama_index-0.6.8/llama_index/vector_stores/pinecone.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/vector_stores/qdrant.py` & `llama_index-0.6.8/llama_index/vector_stores/qdrant.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/vector_stores/redis.py` & `llama_index-0.6.8/llama_index/vector_stores/redis.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/vector_stores/registry.py` & `llama_index-0.6.8/llama_index/vector_stores/registry.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/vector_stores/simple.py` & `llama_index-0.6.8/llama_index/vector_stores/simple.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/vector_stores/types.py` & `llama_index-0.6.8/llama_index/vector_stores/types.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/vector_stores/utils.py` & `llama_index-0.6.8/llama_index/vector_stores/utils.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index/vector_stores/weaviate.py` & `llama_index-0.6.8/llama_index/vector_stores/weaviate.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/llama_index.egg-info/PKG-INFO` & `llama_index-0.6.8/llama_index.egg-info/PKG-INFO`
...
### Comparing `llama_index-0.6.7/llama_index.egg-info/SOURCES.txt` & `llama_index-0.6.8/llama_index.egg-info/SOURCES.txt`
...
### Comparing `llama_index-0.6.7/setup.py` & `llama_index-0.6.8/setup.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/callbacks/test_llama_debug.py` & `llama_index-0.6.8/tests/callbacks/test_llama_debug.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/conftest.py` & `llama_index-0.6.8/tests/conftest.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/embeddings/test_base.py` & `llama_index-0.6.8/tests/embeddings/test_base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/composability/test_utils.py` & `llama_index-0.6.8/tests/indices/composability/test_utils.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/conftest.py` & `llama_index-0.6.8/tests/indices/conftest.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/document_summary/test_index.py` & `llama_index-0.6.8/tests/indices/document_summary/test_index.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/empty/test_base.py` & `llama_index-0.6.8/tests/indices/empty/test_base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/keyword_table/test_base.py` & `llama_index-0.6.8/tests/indices/keyword_table/test_base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/keyword_table/test_retrievers.py` & `llama_index-0.6.8/tests/indices/keyword_table/test_retrievers.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/keyword_table/test_utils.py` & `llama_index-0.6.8/tests/indices/keyword_table/test_utils.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/knowledge_graph/test_base.py` & `llama_index-0.6.8/tests/indices/knowledge_graph/test_base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/knowledge_graph/test_retrievers.py` & `llama_index-0.6.8/tests/indices/knowledge_graph/test_retrievers.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/list/test_index.py` & `llama_index-0.6.8/tests/indices/list/test_index.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/list/test_retrievers.py` & `llama_index-0.6.8/tests/indices/list/test_retrievers.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/postprocessor/test_base.py` & `llama_index-0.6.8/tests/indices/postprocessor/test_base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/postprocessor/test_llm_rerank.py` & `llama_index-0.6.8/tests/indices/postprocessor/test_llm_rerank.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/query/conftest.py` & `llama_index-0.6.8/tests/indices/query/conftest.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/query/query_transform/test_base.py` & `llama_index-0.6.8/tests/indices/query/query_transform/test_base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/query/test_compose.py` & `llama_index-0.6.8/tests/indices/query/test_compose.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/query/test_compose_vector.py` & `llama_index-0.6.8/tests/indices/query/test_compose_vector.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/query/test_query_bundle.py` & `llama_index-0.6.8/tests/indices/query/test_query_bundle.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/struct_store/conftest.py` & `llama_index-0.6.8/tests/indices/struct_store/conftest.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/struct_store/test_base.py` & `llama_index-0.6.8/tests/indices/struct_store/test_base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/struct_store/test_pandas.py` & `llama_index-0.6.8/tests/indices/struct_store/test_pandas.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/struct_store/test_sql_query.py` & `llama_index-0.6.8/tests/indices/struct_store/test_sql_query.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/test_loading.py` & `llama_index-0.6.8/tests/indices/test_loading.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/test_loading_graph.py` & `llama_index-0.6.8/tests/indices/test_loading_graph.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/test_node_utils.py` & `llama_index-0.6.8/tests/indices/test_node_utils.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/test_prompt_helper.py` & `llama_index-0.6.8/tests/indices/test_prompt_helper.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/tree/conftest.py` & `llama_index-0.6.8/tests/indices/tree/conftest.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/tree/test_embedding_retriever.py` & `llama_index-0.6.8/tests/indices/tree/test_embedding_retriever.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/tree/test_index.py` & `llama_index-0.6.8/tests/indices/tree/test_index.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/tree/test_retrievers.py` & `llama_index-0.6.8/tests/indices/tree/test_retrievers.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/vector_store/auto_retriever/test_output_parser.py` & `llama_index-0.6.8/tests/indices/vector_store/auto_retriever/test_output_parser.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/vector_store/conftest.py` & `llama_index-0.6.8/tests/indices/vector_store/conftest.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/vector_store/mock_faiss.py` & `llama_index-0.6.8/tests/indices/vector_store/mock_faiss.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/vector_store/mock_services.py` & `llama_index-0.6.8/tests/indices/vector_store/mock_services.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/vector_store/test_faiss.py` & `llama_index-0.6.8/tests/indices/vector_store/test_faiss.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/vector_store/test_myscale.py` & `llama_index-0.6.8/tests/indices/vector_store/test_myscale.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/vector_store/test_pinecone.py` & `llama_index-0.6.8/tests/indices/vector_store/test_pinecone.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/vector_store/test_retrievers.py` & `llama_index-0.6.8/tests/indices/vector_store/test_retrievers.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/vector_store/test_simple.py` & `llama_index-0.6.8/tests/indices/vector_store/test_simple.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/indices/vector_store/utils.py` & `llama_index-0.6.8/tests/indices/vector_store/utils.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/langchain_helpers/test_text_splitter.py` & `llama_index-0.6.8/tests/langchain_helpers/test_text_splitter.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/llm_predictor/test_base.py` & `llama_index-0.6.8/tests/llm_predictor/test_base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/logger/test_base.py` & `llama_index-0.6.8/tests/logger/test_base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/mock_utils/mock_predict.py` & `llama_index-0.6.8/tests/mock_utils/mock_predict.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/mock_utils/mock_prompts.py` & `llama_index-0.6.8/tests/mock_utils/mock_prompts.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/mock_utils/mock_text_splitter.py` & `llama_index-0.6.8/tests/mock_utils/mock_text_splitter.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/mock_utils/mock_utils.py` & `llama_index-0.6.8/tests/mock_utils/mock_utils.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/optimization/test_base.py` & `llama_index-0.6.8/tests/optimization/test_base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/output_parsers/test_base.py` & `llama_index-0.6.8/tests/output_parsers/test_base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/output_parsers/test_selection.py` & `llama_index-0.6.8/tests/output_parsers/test_selection.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/playground/test_base.py` & `llama_index-0.6.8/tests/playground/test_base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/prompts/test_base.py` & `llama_index-0.6.8/tests/prompts/test_base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/readers/test_file.py` & `llama_index-0.6.8/tests/readers/test_file.py`
...
### Comparing `llama_index-0.6.7/tests/readers/test_json.py` & `llama_index-0.6.8/tests/readers/test_json.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/readers/test_mongo.py` & `llama_index-0.6.8/tests/readers/test_mongo.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/selectors/test_llm_selectors.py` & `llama_index-0.6.8/tests/selectors/test_llm_selectors.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/storage/conftest.py` & `llama_index-0.6.8/tests/storage/conftest.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/storage/docstore/test_mongo_docstore.py` & `llama_index-0.6.8/tests/storage/docstore/test_mongo_docstore.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/storage/docstore/test_simple_docstore.py` & `llama_index-0.6.8/tests/storage/docstore/test_simple_docstore.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/storage/test_storage_context.py` & `llama_index-0.6.8/tests/storage/test_storage_context.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/test_utils.py` & `llama_index-0.6.8/tests/test_utils.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/token_predictor/test_base.py` & `llama_index-0.6.8/tests/token_predictor/test_base.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/vector_stores/test_qdrant.py` & `llama_index-0.6.8/tests/vector_stores/test_qdrant.py`

 * *Files identical despite different names*

### Comparing `llama_index-0.6.7/tests/vector_stores/test_weaviate.py` & `llama_index-0.6.8/tests/vector_stores/test_weaviate.py`
