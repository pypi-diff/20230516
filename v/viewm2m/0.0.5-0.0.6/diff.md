# Comparing `tmp/viewm2m-0.0.5.tar.gz` & `tmp/viewm2m-0.0.6.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "viewm2m-0.0.5.tar", last modified: Tue May 16 14:23:37 2023, max compression
+gzip compressed data, was "viewm2m-0.0.6.tar", last modified: Tue May 16 14:25:27 2023, max compression
```

## Comparing `viewm2m-0.0.5.tar` & `viewm2m-0.0.6.tar`

### file list

```diff
@@ -1,16 +1,16 @@
-drwxr-xr-x   0 liufangjing   (501) staff       (20)        0 2023-05-16 14:23:37.630231 viewm2m-0.0.5/
--rw-r--r--   0 liufangjing   (501) staff       (20)      453 2023-05-16 14:23:37.630118 viewm2m-0.0.5/PKG-INFO
--rw-r--r--   0 liufangjing   (501) staff       (20)        0 2023-05-16 12:08:58.000000 viewm2m-0.0.5/README.md
--rw-r--r--   0 liufangjing   (501) staff       (20)       38 2023-05-16 14:23:37.630260 viewm2m-0.0.5/setup.cfg
--rw-r--r--   0 liufangjing   (501) staff       (20)     1924 2023-05-16 14:23:32.000000 viewm2m-0.0.5/setup.py
-drwxr-xr-x   0 liufangjing   (501) staff       (20)        0 2023-05-16 14:23:37.629261 viewm2m-0.0.5/viewm2m/
--rw-r--r--   0 liufangjing   (501) staff       (20)      435 2023-05-16 14:21:38.000000 viewm2m-0.0.5/viewm2m/__init__.py
--rw-r--r--   0 liufangjing   (501) staff       (20)     6540 2023-05-16 14:11:57.000000 viewm2m-0.0.5/viewm2m/captor.py
--rw-r--r--   0 liufangjing   (501) staff       (20)     6819 2023-05-16 13:43:11.000000 viewm2m-0.0.5/viewm2m/viewm2m.py
-drwxr-xr-x   0 liufangjing   (501) staff       (20)        0 2023-05-16 14:23:37.629988 viewm2m-0.0.5/viewm2m.egg-info/
--rw-r--r--   0 liufangjing   (501) staff       (20)      453 2023-05-16 14:23:37.000000 viewm2m-0.0.5/viewm2m.egg-info/PKG-INFO
--rw-r--r--   0 liufangjing   (501) staff       (20)      263 2023-05-16 14:23:37.000000 viewm2m-0.0.5/viewm2m.egg-info/SOURCES.txt
--rw-r--r--   0 liufangjing   (501) staff       (20)        1 2023-05-16 14:23:37.000000 viewm2m-0.0.5/viewm2m.egg-info/dependency_links.txt
--rw-r--r--   0 liufangjing   (501) staff       (20)       50 2023-05-16 14:23:37.000000 viewm2m-0.0.5/viewm2m.egg-info/entry_points.txt
--rw-r--r--   0 liufangjing   (501) staff       (20)       29 2023-05-16 14:23:37.000000 viewm2m-0.0.5/viewm2m.egg-info/requires.txt
--rw-r--r--   0 liufangjing   (501) staff       (20)        8 2023-05-16 14:23:37.000000 viewm2m-0.0.5/viewm2m.egg-info/top_level.txt
...
### Comparing `viewm2m-0.0.5/setup.py` & `viewm2m-0.0.6/setup.py`
...
### Comparing `viewm2m-0.0.5/viewm2m/captor.py` & `viewm2m-0.0.6/viewm2m/captor.py`

 * *Files identical despite different names*

### Comparing `viewm2m-0.0.5/viewm2m/viewm2m.py` & `viewm2m-0.0.6/viewm2m/viewm2m.py`
