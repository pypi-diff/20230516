# Comparing `tmp/viewm2m-0.0.4.tar.gz` & `tmp/viewm2m-0.0.5.tar.gz`
...
## Comparing `viewm2m-0.0.4.tar` & `viewm2m-0.0.5.tar`
...
### Comparing `viewm2m-0.0.4/setup.py` & `viewm2m-0.0.5/setup.py`
...
### Comparing `viewm2m-0.0.4/viewm2m/captor.py` & `viewm2m-0.0.5/viewm2m/captor.py`

 * *Files identical despite different names*

### Comparing `viewm2m-0.0.4/viewm2m/viewm2m.py` & `viewm2m-0.0.5/viewm2m/viewm2m.py`
